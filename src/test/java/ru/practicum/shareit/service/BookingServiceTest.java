...
class BookingServiceTest {
    ...
    public void shouldThrowUserNodFoundExceptionInGetAllBooking() {
        ...
        assertThrows(UserNotFoundException.class,
                () -> service.getAllBookingByUserId(1L, State.ALL, null, null));
    ...
    public void shouldGetAllBookingWhenStateEqAll() {
        ...
        Mockito
                .when(repository.findAll(Mockito.any(BooleanExpression.class), Mockito.any(Sort.class)))
                .thenReturn(new ArrayList<>());

        Collection<BookingDto> bookings = service.getAllBookingByUserId(1L, State.ALL, null, null);
    ...
    public void shouldGetAllBookingWhenStateEqCurrent() {
        ...
        Collection<BookingDto> bookings = service.getAllBookingByUserId(1L, State.CURRENT, null, null);
    ...
    public void shouldGetAllBookingWhenStateEqFuture() {
        ...
        Collection<BookingDto> bookings = service.getAllBookingByUserId(1L, State.FUTURE, null, null);
    ...
    public void shouldGetAllBookingWhenStateEqPast() {
        ...
        Collection<BookingDto> bookings = service.getAllBookingByUserId(1L, State.PAST, null, null);
    ...
    public void shouldGetAllBookingWhenStateEqWaiting() {
        ...
        Collection<BookingDto> bookings = service.getAllBookingByUserId(1L, State.WAITING, null, null);
    ...
    public void shouldGetAllBookingWhenStateEqRejected() {
        ...
        Collection<BookingDto> bookings = service.getAllBookingByUserId(1L, State.REJECTED, null, null);
    ...
    public void shouldThrowItemNodFoundExceptionInGetAllBookedItems() {
        ...
        assertThrows(ItemNotFoundException.class,
                () -> service.getAllBookedItemsByUserId(1L, State.ALL, null, null));
