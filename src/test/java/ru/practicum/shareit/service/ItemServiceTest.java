...
class ItemServiceTest {
    ...
    public void shouldReturnNewListWhenTextSearchIsBlank() {
        ...
        Collection<ItemDto> itemDto = service.search(" ", null, null);
    ...
    @Test
    public void shouldReturnSearchWithoutPagination() {

        Collection<ItemDto> itemDto = service.search("text", null, null);
    ...
    public void shouldReturnSearchWithPagination() {
        ...
        Collection<ItemDto> itemDto = service.search("text", 0, 0);
