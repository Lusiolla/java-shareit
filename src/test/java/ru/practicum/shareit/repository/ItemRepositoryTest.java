...
public class ItemRepositoryTest {
    ...
    public void search() {
        ...
        Collection<Item> targetItems = itemRepository.search("description1");
    ...
    public void searchByParam() {
        ...
        Collection<Item> targetItems = itemRepository.searchByParam(
                "test2", 1, 0);
        Collection<Item> emptyItems = itemRepository.searchByParam(
                "test2", 0, 0);
